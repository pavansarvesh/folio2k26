    ...
    <div id="top" className="relative min-h-screen overflow-hidden bg-neutral-950 text-white">
      ...
      <main className="relative mx-auto max-w-6xl px-6 py-16 sm:py-20">
        ...
        <p className="mt-6 max-w-2xl text-base leading-7 text-white/70 sm:text-lg">
          Stay connected and follow my journey on social media for updates, projects, and more.
        </p>
        ...
        <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-6">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {links.map((link) => (
              ...
              >
                <span className="text-white/80 transition group-hover:text-orange-500">{link.icon}</span>
