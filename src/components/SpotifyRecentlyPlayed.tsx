...
const SPOTIFY_PROFILE_URL =
	"https://open.spotify.com/user/31gei7c57di3xjoy7zqzgqx6bnpy?si=3bf3390242af48ca";
			...
			<div className='rounded-xl border border-neutral-800 bg-neutral-900/30 p-4'>
				<div className='flex items-center gap-6'>
					<img
						src={track.image}
						alt={track.name}
						className='h-20 w-20 shrink-0 rounded-xl border border-white/10 object-cover sm:h-28 sm:w-28'
						loading='lazy'
						decoding='async'
					/>
